...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://40n3bxgt4k.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.reportPost = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(reportPostRequest, authType, additionalParams, config.apiKey);
    };
